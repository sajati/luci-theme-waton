...
return baseclass.extend({
	...
	render: function(tree) {
		...
		document.querySelector('#topbar > #topbar-left .navigation')
		.addEventListener('click', ui.createHandlerFn(this, 'handleSidebarToggle'));
		document.querySelector('#topbar > #topbar-right #themeModeSwitcher')
		.addEventListener('click', ui.createHandlerFn(this,'switchThemeMode'));
	},
	...
	switchThemeMode: function(ev){
		var btn = ev.currentTarget,
		style = document.querySelector("#dynamicstylesheet");

		if (btn.classList.contains('themeModeSwitchNight')) {
			btn.classList.remove('themeModeSwitchNight');
			btn.classList.add('themeModeSwitchDay');
			style.href = "/luci-static/waton/stylesheets/night.css";
		}
		else {
			btn.classList.remove('themeModeSwitchDay');
			btn.classList.add('themeModeSwitchNight');
			style.href = "/luci-static/waton/stylesheets/day.css";
		}
	}
});